...
public class CustomViewAbove extends ViewGroup {
	...
	private SlidingMenu.CanvasTransformer mCanvasTransformer;

	public void setCanvasTransformer(SlidingMenu.CanvasTransformer canvasTransformer) {
		mCanvasTransformer = canvasTransformer;
	}
	...
	public void scrollTo(int x, int y) {
		super.scrollTo(x, y);
		//类比CustomViewBehind添加的
		if (mCanvasTransformer != null)
			invalidate();
		mScrollX = x;
	...
	//类比CustomViewBehind进行修改 ---改动较大
	@Override
	protected void dispatchDraw(Canvas canvas) {
		if (mCanvasTransformer != null) {
			canvas.save();
//			mCanvasTransformer.transformCanvas(canvas, mViewAbove.getPercentOpen());
			mCanvasTransformer.transformCanvas(canvas, this.getPercentOpen());
